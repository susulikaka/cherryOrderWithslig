...
@implementation LKDropdownAlert{
    UILabel *titleLabel;
...
{
    defaultViewColor = [UIColor redColor];//%%% default color from slingshot
...
+(LKDropdownAlert*)alertView {
    LKDropdownAlert *alert = [[self alloc]initWithFrame:CGRectMake(0, -HEIGHT, SCREEN_WIDTH, HEIGHT)];
    return alert;
}

+(LKDropdownAlert*)alertViewWithDelegate:(id<RKDropdownAlertDelegate>)delegate
{
    LKDropdownAlert *alert = [[self alloc]initWithFrame:CGRectMake(0, -HEIGHT, SCREEN_WIDTH, HEIGHT)];
