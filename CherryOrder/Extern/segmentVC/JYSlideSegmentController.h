...
- (BOOL)slideSegment:(UICollectionView *)segmentBar didScrollToViewController:(UIViewController *)viewController;
@end
...
@property (nonatomic, assign) CGFloat fixedBarItemWidth;
